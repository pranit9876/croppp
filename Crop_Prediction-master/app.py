...
@app.route('/index')
def home():
    title = 'KrushiVal- Home'
    return render_template('indexx.html',title=title)

@app.route('/form')
def form():
    title = 'KrushiVal - Crop'
    return render_template('form.html',title=title)

@app.route('/cropresult')
def cropresult():
    title = 'KrushiVal - Cropresult'
    return render_template('cropresult.html',title=title)

@app.route('/layout')
def layout():
    title = 'KrushiVal - layout'
    return render_template('layout.html',title=title)

@app.route('/predict', methods=['POST'])
def predict():
    title = 'KrushiVal- Crop Recommendation'
    '''
